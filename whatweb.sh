...
clear
echo "#########################################################################"
echo "#     ________   ______   __    __       __    __   __   ______         #"
echo "#    /  _____/  /  __  \ |  |  |  |     |  |  |  | |  | /  __  \        #"
echo "#   |  |  __   |  |  |  ||  |__|  |     |  |__|  | |  ||  |  |  |       #"
echo "#   |  | |_ |  |  |  |  ||   __   |     |   __   | |  ||  |  |  |       #"
echo "#   |  |__| |  |  `--'  ||  |  |  |     |  |  |  | |  ||  `--'  |       #"
echo "#    \______|   \______/ |__|  |__|     |__|  |__| |__| \______/        #"
echo "#                                                                       #"
echo "#           WhatWeb Installer - Powered by G3K                         #"
echo "#        github.com/g333k | fabian.huamani@ucsm.edu.pe                #"
echo "#########################################################################"
echo
